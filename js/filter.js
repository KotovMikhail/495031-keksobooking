...
(function () {
  ...
  // window.filter.onFormFilterChange = window.debounce(window.filter.onFormFilterChange);
  var onFilterFormReset = function () {
    filterForm.removeEventListener('change', onFormFilterChange);
  };

  filterForm.addEventListener('change', onFormFilterChange);

  resetButton.addEventListener('click', onFilterFormReset);
})();
