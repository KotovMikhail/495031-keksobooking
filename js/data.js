...
(function () {
  ...
  window.data = {
    createObject: function () {
      var locationX = window.util.getRandom(0, (window.widthMap - window.constants.PIN_WIDTH / 2));
      var locationY = window.util.getRandom(window.constants.MIN_LOCATION_Y, window.constants.MAX_LOCATION_Y);
      return {
        author: {
  ...
  window.cardsArray = window.data.createData();
